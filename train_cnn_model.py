...
def train_cnn_model():
    ...
    callbacks = [
        ...
        ModelCheckpoint(filepath=os.path.join(SAVE_DIR, 'cnn_{epoch:02d}-{val_accuracy:.4f}.h5'), 
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(SAVE_DIR, 'cnn_training_history.png'))
    
    logger.info("CNN model training completed. Model saved to 'models/cnn_model.h5'")
